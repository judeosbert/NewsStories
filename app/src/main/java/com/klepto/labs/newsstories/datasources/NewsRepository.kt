...
class NewsRepository @Inject constructor(private val mApiService: ApiService, private val mDbManager: DatabaseManager,private val mSharedPrefManager: SharedPrefManager):BaseRepository() {
